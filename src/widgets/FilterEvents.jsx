...
export const FilterEvents = ({ setEvent, clear }) => {
    ...
    }, [token, clear, error, setEvent, record])
    ...
    return (
        <div className='absolute'>
            <input
                type="text"
                className="w-[220px] md:w-[250px] bg-transparent p-2 border border-gray-400 dark:border-slate-700 dark:text-gray-500 text-sm rounded-md"
                value={isSelected ? selected : filtered}
                placeholder="Type and click on event to select"
                onChange={(e) => updateFilter(e.target.value)}
            />
            <div className='relative inset-0 overflow-y-auto w-full z-10'>
