...
export const FilterYears = ({ setYear, clear }) => {
    ...
    return (
        <div className='absolute'>
            <input
                type="text"
                className="w-[150px] bg-transparent p-2 border border-gray-400 dark:border-slate-700 dark:text-gray-400 text-sm rounded-md"
                value={isSelected ? selected : filtered}
                placeholder="Type & select year"
                onChange={(e) => updateFilter(e.target.value)}
            />
            <div className='relative inset-0 z-10 overflow-y-auto w-[150px]'>
