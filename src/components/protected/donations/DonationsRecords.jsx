            ...
            if(search) {
                computedDonations = computedDonations.filter(
                    donatn => donatn.member_group.toLowerCase().includes(search.toLowerCase()) ||
                            ...
                            donatn.redeemed.toString().includes(search) ||
                            donatn.donation.toString().includes(search) ||
        ...
        <Fragment>
            ...
            {(donations !== null && donations !== undefined && donations.length > 0) && 
                <div className='w-full grid md:flex justify-between my-4'>
                    <div className='flex justify-start bg-gray-100 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 px-2 pt-3 pb-2 space-x-2 md:space-x-12 text-sm text-gray-500 dark:text-gray-400 mb-3 md:mb-0'>
